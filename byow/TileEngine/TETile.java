...
public class TETile {
    ...
    /**
     * tests if two tiles are the same
     * @param one first comparing Tile object
     * @param two second object
     * @return boolean value
     */
    public static boolean tileEquals(TETile one, TETile two) {
        if(one.description.equals(two.description)){
            return true;
        }
        return false;
    }
